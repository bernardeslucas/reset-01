...
import br.com.cwi.tinderevolution.domain.game.GameGenres;
import br.com.cwi.tinderevolution.domain.game.GamePlatforms;
    ...
    private Game info() {
        ...
        switch (genreOption) {
            case 1:
                ...
                break;
            case 2:
                gameGenre = GameGenres.FIGHT;
                break;
            case 3:
                gameGenre = GameGenres.HORROR;
                break;
            case 4:
                gameGenre = GameGenres.RPG;
                break;
            case 5:
                gameGenre = GameGenres.SANDBOX;
                break;
            case 6:
                gameGenre = GameGenres.SPORTS;
                break;
        }
        cont = 1;
