...
public class Combate {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Mago | Nome: " + mago1.nome + " | Vida: " + mago1.vida + " | Mana: " + mago1.mana);
                 */
        barbaro1.imprimirEstado();
        clerigo1.imprimirEstado();
        guerreiro1.imprimirEstado();
        druida1.imprimirEstado();
        feiticeiro1.imprimirEstado();
        feiticeiro2.imprimirEstado();
        mago1.imprimirEstado();
